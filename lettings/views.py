...
# massa. Integer est nunc, pulvinar a tempor et, bibendum id arcu. Vestibulum ante ipsum
# primis in faucibus orci luctus et ultrices posuere cubilia curae; Cras eget scelerisque
def index(request):
...
# eget bibendum lorem. Sed non dolor risus. Mauris condimentum auctor elementum. Donec
# quis nisi ligula. Integer vehicula tincidunt enim, ac lacinia augue pulvinar sit amet.
def letting(request, letting_id):
    ...
    return render(request, 'lettings/templates/letting.html', context)