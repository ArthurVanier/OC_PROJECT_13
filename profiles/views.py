...
# libero pulvinar eget. Fusc faucibus, urna quis auctor pharetra, massa dolor
# cursus neque, quis dictum lacus d
def index(request):
    print('test')
...
# aliquam dignissim congue. Pellentesque habitant morbi tristique senectus et netus
# et males
